...
public class SecurityCheckCommand : CliktCommand(name = "security-check") {
    ...
    public val format: String by option("--format", help = "Output format: text, json, sarif").default("text")
    ...
    public val osvApi: String by option("--osv-api", help = "OSV API URL").default("https://api.osv.dev")
