...
public class ResolveTransitivesCommand : CliktCommand(name = "resolve-transitives") {
    ...
    public val format: String by option("--format", help = "Format: json, yaml, tree, text").default("text")
    ...
    public val conflictResolution: String by option("--conflict-resolution", help = "Strategy: HIGHEST,FIRST,FAIL").default("HIGHEST")
