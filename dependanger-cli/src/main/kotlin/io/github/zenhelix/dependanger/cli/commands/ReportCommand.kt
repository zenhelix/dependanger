...
public class ReportCommand : CliktCommand(name = "report") {
    ...
    public val input: String by option("-i", "--input", help = "Input metadata/effective file").default("metadata.json")
    public val outputDir: String by option("-o", "--output-dir", help = "Output directory").default(".")
    public val format: String by option("--format", help = "Format: json, yaml, markdown, html").default("markdown")
