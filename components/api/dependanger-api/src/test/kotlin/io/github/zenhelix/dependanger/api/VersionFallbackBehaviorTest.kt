...
class VersionFallbackBehaviorTest {
    ...
    inner class `Kotlin version fallback` {
        ...
        fun `fallback applies when kotlin version matches condition`() = runTest {
            ...
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("1.5")
        }
        ...
        fun `fallback does not apply when kotlin version exceeds condition`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("2.0")
        }
    }
    ...
    inner class `Gradle version fallback` {
        ...
        fun `fallback applies for old gradle version`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("8.0")
        }
        ...
        fun `fallback does not apply for new gradle version`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("9.0")
        }
    }
    ...
    inner class `Multiple fallbacks with priority` {
        ...
        fun `first matching fallback wins`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("android")
        }
        ...
        fun `second fallback matches when first does not`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("for-jdk-11")
        }
    }
    ...
    inner class `Composite conditions` {
        ...
        fun `all combinator fails when one condition does not match`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("1.0")
        }
        ...
        fun `any combinator matches when at least one condition matches`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("compat")
        }
        ...
        fun `not combinator inverts condition - fallback applies when negated condition is true`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["lib"]!!.version.valueOrNull).isEqualTo("non-lts")
        }
    ...
    inner class `Fallback with library resolution` {
        ...
        fun `fallback version is used in library version resolution`() = runTest {
            ...
            assertThat(lib.version.valueOrNull).isEqualTo("33.0-android")
        }
        ...
        fun `multiple libraries sharing a fallback version all get the fallback value`() = runTest {
            ...
            assertThat(result.isSuccess).isTrue()
            assertThat((result as DependangerResult.Success).effective.libraries["guava-core"]!!.version.valueOrNull)
                .isEqualTo("33.0-android")
            assertThat((result as DependangerResult.Success).effective.libraries["guava-testlib"]!!.version.valueOrNull)
                .isEqualTo("33.0-android")
        }
    }
}
